<?php
/**
 * Post card (used in blog/archive grids).
 *
 * @package Voltalux
 */
?>
<article id="post-<?php the_ID(); ?>" <?php post_class( 'vlx-card' ); ?>>
	...
	<div class="vlx-card__body">
		...
		<a class="vlx-card__more" href="<?php the_permalink(); ?>">
			<?php esc_html_e( 'Lees meer', 'voltalux' ); ?> <?php echo voltalux_arrow_svg(); // phpcs:ignore ?>
		</a>
	</div>
</article>
