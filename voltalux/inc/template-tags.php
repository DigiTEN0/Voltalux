...
function voltalux_icon( $name ) {
	...
	$icons = array(
		...
		'snow'    => '<path d="M12 3L12 21M19.79 7.5L4.21 16.5M19.79 16.5L4.21 7.5"/><path d="M13.89 5.52L12 7L10.11 5.52M18.56 10.4L16.33 9.5L16.66 7.12M16.66 16.88L16.33 14.5L18.56 13.6M10.11 18.48L12 17L13.89 18.48M5.44 13.6L7.67 14.5L7.34 16.88M7.34 7.12L7.67 9.5L5.44 10.4"/>',
		...
		'heat'    => '<circle cx="12" cy="12" r="1.4"/><path d="M12 10.6c-1-3.4-.4-5.6 1.2-6.1 1.5-.5 2.7 1.2 1.5 3.6M13.4 12c3.4-1 5.6-.4 6.1 1.2.5 1.5-1.2 2.7-3.6 1.5M12 13.4c1 3.4.4 5.6-1.2 6.1-1.5.5-2.7-1.2-1.5-3.6M10.6 12c-3.4 1-5.6.4-6.1-1.2-.5-1.5 1.2-2.7 3.6-1.5"/>',
		'ev'      => '<rect x="5.5" y="3" width="9" height="18" rx="2"/><path d="M5.5 8h9"/><path d="M14.5 10h1.5a2 2 0 012 2v3.5a1.75 1.75 0 003.5 0V9.5L19 7"/><path d="M10.2 12l-1.7 3h2.4l-1.7 3"/>',
